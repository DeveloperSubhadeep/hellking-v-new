...
async def send_msg(bot, filename, caption, file_size):
    try:
        ...
        # qualities = ["ORG", "org", "hdcam", "HDCAM", "HQ", "hq", "HDRip", "hdrip", "camrip", "CAMRip", "hdtc", "predvd", "DVDscr", "dvdscr", "dvdrip", "dvdscr", "HDTC", "dvdscreen", "HDTS", "hdts"]
        # quality = await get_qualities(caption.lower(), qualities) or "HDTC"
        ...
        if await add_name(OWNERID, filename):
            ...
            # New code to create genre hashtags
#             genre_list = genres.split(',')
#             genre_hashtags = []
#             for genre in genre_list:
#                 # Remove leading/trailing whitespace and convert to lowercase
...
#                 "📽 ғᴏʀᴍᴀᴛ: {quality}\n"
#                 "🔊 ᴀᴜᴅɪᴏ: {language}\n\n"
#                 "{genre_hashtags_text}\n"  # Use the new hashtag string here
#                 "{kind_hashtag}\n\n"        # Use the kind hashtag here
#                 "𝖴𝗉𝗅𝗈𝖺𝖽𝖾𝖽 𝖡𝗒 - @Hell_king_69_Bot\n\n"
#                 "🕒 {timestamp}"
#             )

#             # You will need to format the new variables as well
#             text = text_template.format(
#                 title=title,
#                 year=year,
#                 genres=genres, # This will still display "Drama, Romance, love,..."
#                 quality=quality,
#                 language=language,
#                 genre_hashtags_text=genres_to_display, # This is the new hashtag string
#                 kind_hashtag=hashtag, # This is the original hashtag
#                 timestamp=timestamp
#             )
